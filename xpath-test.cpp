...
TEST(xpath, axis_following_sibling)
{
  nodeset_t *ns;
  xpath_step_t step;
  xpath_axis_test_t d;
...
TEST(xpath, axis_preceding_sibling)
{
  nodeset_t *ns;
  xpath_step_t step;
  xpath_axis_test_t d;
...
TEST(xpath, axis_descendant_or_self)
{
  nodeset_t *ns;
  xpath_step_t step;
  xpath_axis_test_t d;
...
TEST(xpath, axis_ancestor_or_self)
{
  nodeset_t *ns;
  xpath_step_t step;
  xpath_axis_test_t d;
